...
function enemyStartUnits(): UnitSnapshot[] {
  return [
    ...
    makeUnit({ id: "e-basic-2", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 6, r: -1 }),
    makeUnit({ id: "e-basic-3", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 5, r: 2 }),
    makeUnit({ id: "e-basic-4", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 5, r: 1 }),
    makeUnit({ id: "e-basic-5", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 5, r: 0 }),
    makeUnit({ id: "e-basic-6", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 7, r: -3 }),
    makeUnit({ id: "e-basic-7", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 6, r: -2 }),
    makeUnit({ id: "e-basic-8", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 5, r: -1 }),
    makeUnit({ id: "e-basic-9", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 4, r: 3 }),
    makeUnit({ id: "e-basic-10", name: "Basic", definitionId: "basic", team: "PLAYER_TWO", unitType: "BASIC", q: 4, r: 2 }),
  ];
}
...
export function battleStartSnapshot(): GameStateSnapshot {
  return {
    ...
    units: [
      ...
      makeUnit({ id: "u-basic-2", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -6, r: 1 }),
      makeUnit({ id: "u-basic-3", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -5, r: -2 }),
      makeUnit({ id: "u-basic-4", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -5, r: -1 }),
      makeUnit({ id: "u-basic-5", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -5, r: 0 }),
      makeUnit({ id: "u-basic-6", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -7, r: 3 }),
      makeUnit({ id: "u-basic-7", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -6, r: 2 }),
      makeUnit({ id: "u-basic-8", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -5, r: 1 }),
      makeUnit({ id: "u-basic-9", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -4, r: -3 }),
      makeUnit({ id: "u-basic-10", name: "Basic", definitionId: "basic", team: "PLAYER_ONE", unitType: "BASIC", q: -4, r: -2 }),
      ...enemyStartUnits(),
    ],
  };
}
